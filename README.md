...
metaAndAssetCtxs: Market data & current funding rates.
fundingHistory: Historical rate data.
meta: General market information.
Note: All API calls are made directly to https://api.hyperliquid.xyz/info without requiring authentication.
🚀 Deployment
