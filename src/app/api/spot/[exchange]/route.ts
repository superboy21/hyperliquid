...
type ExchangeSlug = "hyperliquid" | "gateio" | "binance" | "lighter" | "okx" | "bitget";
type SpotAction = "list" | "candles" | "book";
type Fetcher = (url: string | URL, init?: RequestInit & { timeout?: number }) => Promise<Response>;

const HOSTS: Record<ExchangeSlug, string> = {
...
export interface SpotUpstreamRequest { url: string; init: RequestInit & { timeout?: number } }
